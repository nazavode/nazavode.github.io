...
memory location as the previous one (`%rsi,%rdx,4`) in a different vector
...
different legal ways. These *could be* valid aliases:
...
to blindly follow the standard with the proper flag:
